...
const CONFIG_SECCION = {
    seccion: "I. Gestión Institucional y Gestión del Acervo",
    ...
    preguntas: [
        ...
        },
        {
            ...
            graficar: true,
            opciones: [
                { id: 1, texto: "Incipiente", ayuda: "Se opera sin una planeación estratégica, sin organigrama ni manuales de procedimiento que den orden al trabajo institucional. Se carece de procesos formales para la gestión del acervo, lo que pone al acervo en una situación altamente vulnerable ante daños o pérdidas. No hay mecanismos de seguimiento de resultados. No se cuenta con financiamiento o el que se tiene no es estable." },
